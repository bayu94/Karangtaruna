...
<div class="page-title">
  <div>
    <h1><i class="fa fa-file-text"></i> Data Agenda Yang Telah Di Setujui</h1>
    <ul class="breadcrumb side">
      <li><i class="fa fa-home fa-lg"></i></li>
      <li class="active"><a href="#">Data Agenda Yang Telah Di Setujui</a></li>
    </ul>
  </div>
  <div>
    <?php if ($this->session->userdata('status')!="2"): ?>
     <a class="btn btn-primary btn-flat" style="display: none;" href="<?php echo base_url('Agenda/form'); ?>"><i class="fa fa-lg fa-plus"></i></a>
    <?php else: ?>
      <a class="btn btn-primary btn-flat" href="<?php echo base_url('Agenda/form'); ?>"><i class="fa fa-lg fa-plus"></i></a>
    <?php endif ?>
  </div>
</div>
              ...
              <div class="card-body">
				...
				// die();
                    ...
                    <tr>
                      ...
                      <?php else: ?>
                        <td>
                      	<a class="btn btn-primary btn-flat" href="<?php echo base_url('Agenda/form/'.$value['pesan_id']); ?>"><i class="fa fa-lg fa-refresh"></i></a>
                      	<a class="btn btn-warning btn-flat AgenDel" data-id="<?php echo $value['pesan_id']; ?>" ><i class="fa fa-lg fa-trash"></i></a>
                      	<a data-toggle="modal" data-target="#statusModal" class="btn btn-info updatestatus" data-pesan="<?php echo $value['pesan_id']; ?>" ><i class="fa fa-lg fa-edit"></i></a>
...
<div class="modal fade" id="statusModal" tabindex="-1" role="dialog" aria-labelledby="statusModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('Agenda/edit'); ?> " method="post">
