          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-th-list"></i><span>Agenda</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('Agenda'); ?>"><i class="fa fa-circle-o"></i> Data Agenda</a></li>
                <li><a href="<?php echo base_url('Agenda/setuju'); ?>"><i class="fa fa-circle-o"></i> Agenda Sudah Di Persetujui</a></li>
                <li><a href="<?php echo base_url('Agenda/tidak_setuju'); ?>"><i class="fa fa-circle-o"></i> Agenda Tidak Di Persetujui</a></li>
              </ul>
            </li>
          </ul>
        </section>
